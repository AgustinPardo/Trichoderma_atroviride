...
#b2go_IMI_dic=b2GoDic("Tatroviride_IMI_B2GO.txt",False)
iprscan_dic=iprcscnDic("Trichoderma_atroviride_IMI206040.proteins.iprs.tsv")
gff_dic=goGffDic("Trichoderma_atroviride.gff3")

dic_list=[iprscan_dic,gff_dic]
...
salida = open("merge_iprscan_gff.txt","w")
...
# venn3([set(b2go_IMI_list), set(iprscan_list), set(gff_list)],set_labels = ('b2go', 'iprscan', 'gff'),alpha = 0.5)
# plt.show()